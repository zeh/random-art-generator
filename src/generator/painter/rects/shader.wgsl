...
fn renderRectangle(color: vec3<f32>, position: vec2<f32>, rect_position: vec2<f32>, rect_size: vec2<f32>) -> vec4<f32> {
...
fn cs_main([[builtin(global_invocation_id)]] global_id : vec3<u32>) {
	...
	let frag_color: vec4<f32> = renderRectangle(color, vec2<f32>(global_id.xy) + vec2<f32>(0.5, 0.5), position, size);
